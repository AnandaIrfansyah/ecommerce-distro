                                ...
                                <td>
                                    <div class="quantity-wrapper mt-4" style="width: 100px;">
                                        <a href="#" class="edit-qty d-block text-center text-decoration-none"
                                            data-bs-toggle="modal" data-bs-target="#qtyModal" data-id="{{ $item->id }}"
            ...
            <div class="row g-4 justify-content-end mt-2">
                ...
                <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                    <div class="bg-light cart-summary-card">
                        ...
                        <div class="px-4 pb-4">
                            <button class="btn btn-primary w-100 rounded-pill py-3 text-uppercase" type="button">
                                Proceed to Checkout
                            </button>
                        </div>
                    </div>
                ...
                <div class="modal-content border-0 shadow-lg rounded-3">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="modal-quantity" name="quantity" min="1"
                                required>
                        </div>
                    </div>
